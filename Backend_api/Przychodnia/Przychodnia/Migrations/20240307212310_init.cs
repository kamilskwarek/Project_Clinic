        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PregnantRemarks = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    Smoking = table.Column<bool>(type: "bit", nullable: false),
                    SmokingRemarks = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    Alcohol = table.Column<bool>(type: "bit", nullable: false),
                    AlcoholRemarks = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    SpecialDiet = table.Column<bool>(type: "bit", nullable: false),
                    SpecialDietRemarks = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    Allergies = table.Column<bool>(type: "bit", nullable: false),
                    AllergiesRemarks = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    Medications = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    Surgeries = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    Hospitalizations = table.Column<bool>(type: "bit", nullable: false),
                    Asthma = table.Column<bool>(type: "bit", nullable: false),
                    HeartDisease = table.Column<bool>(type: "bit", nullable: false),
                    prostateCancer = table.Column<bool>(type: "bit", nullable: false),
